...
/// @nodoc
abstract class $ApiFetchStateCopyWith<T, $Res> {
  factory $ApiFetchStateCopyWith(
          ApiFetchState<T> value, $Res Function(ApiFetchState<T>) then) =
      _$ApiFetchStateCopyWithImpl<T, $Res, ApiFetchState<T>>;
}

/// @nodoc
class _$ApiFetchStateCopyWithImpl<T, $Res, $Val extends ApiFetchState<T>>
    implements $ApiFetchStateCopyWith<T, $Res> {
  _$ApiFetchStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<T, $Res>
    extends _$ApiFetchStateCopyWithImpl<T, $Res, _$_Initial<T>>
...
abstract class _Initial<T> implements ApiFetchState<T> {
...
class __$$_LoadingCopyWithImpl<T, $Res>
    extends _$ApiFetchStateCopyWithImpl<T, $Res, _$_Loading<T>>
...
abstract class _Loading<T> implements ApiFetchState<T> {
...
class __$$_SuccessCopyWithImpl<T, $Res>
    extends _$ApiFetchStateCopyWithImpl<T, $Res, _$_Success<T>>
...
class _$_Success<T> implements _Success<T> {
  ...
  @override
  String toString() {
    return 'ApiFetchState<$T>.success(value: $value)';
  }
...
abstract class _Success<T> implements ApiFetchState<T> {
  factory _Success(final T value) = _$_Success<T>;
...
class __$$_FailedCopyWithImpl<T, $Res>
    extends _$ApiFetchStateCopyWithImpl<T, $Res, _$_Failed<T>>
...
class _$_Failed<T> implements _Failed<T> {
  ...
  @override
  String toString() {
    return 'ApiFetchState<$T>.failed(e: $e)';
  }
...
abstract class _Failed<T> implements ApiFetchState<T> {
  factory _Failed(final String e) = _$_Failed<T>;
